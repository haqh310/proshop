...
import { getUserProfile, updateUserProfile, resetUserUpdate } from "../actions/userAction";
            ...
            <tbody>
              {orders.map(order => (
                <tr key={order._id}>
                  ...
                  <td>{order.isDelivered ? (<i className="fas fa-check text-success"></i>) : (<i className="fas fa-times text-danger"></i>)}</td>
